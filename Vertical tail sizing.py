...
def rudder_sizing(T_OEI=T_OEI,Clv_max_r=Clv_max_r,y_engine=y_engine,rho_to=rho_to,rho_c=rho_c,Vlof=Vlof,V_c=V_c):
...
print ()
print ('The required vtail area to counteract the OEI moment at take-off is',Req_Sv[0],'[m]')

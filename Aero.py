...
def drag():
    ...
    # print("CD0 Misc fraction= ", (wavedrag + dragupsweep + 0.02*CD0) / CD0 * 100, "CD0 Wave drag = ", wavedrag)
...
#
    ...
    Draglist = []
    clmind = 0.127272727272
    for i in clrange:
        C_D = CD0 + (i - clmind)**2/(np.pi*AR_eff*oswaldclean)
        Draglist.append(C_D)

...
def cabin_design(fractioninfus,fractionintail,HYDROGENVOLUME):
    ...
    #two types I exits
    #two types III exits
    paxsectionlength=round(15*seat_pitch+emergency_clearance+wseat,3) #
    aft_galley_length=1
    ...
    return(t_top, m_top, tm_top, d_top, l_top, t_cyl, m_cyl, tm_cyl, d_cyl, l_cyl, t_tail, m_tail, tm_tail, d_tail, l_tail,totalcabinlength,V_tank_cyl,V_tank_tail,V_tank_top)
    

t_top, m_top, tm_top, d_top, l_top, t_cyl, m_cyl, tm_cyl, d_cyl, l_cyl, t_tail, m_tail, tm_tail, d_tail, l_tail,totalcabinlength,V_tank_cyl,V_tank_tail,V_tank_top=cabin_design(0,0,30)

total_mass=tm_top+tm_cyl+tm_tail
CGalltanks=((tm_top)*(totalcabinlength+l_cyl)/2+(tm_cyl)*(totalcabinlength+l_cyl/2)+(tm_tail)*(totalcabinlength+l_cyl+l_tail/2))/total_mass #CG FROM THE START OF THE CABIN (i.e. front of front galley)

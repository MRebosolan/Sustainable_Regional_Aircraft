...
def tank_sizing(HYDROGENVOLUME,LENGTH,N,TS0=155,TANK_MATERIAL_DENSITY=1780,EMOD=276*10**9,THERMALEXP=-0.64*10**(-6),MAX_ALLOWABLE_STRESS = 5516000000):
    ...
    TANK_THICKNESS_Cc = PRESSURE_GAS/2 *R/(abs(MAX_ALLOWABLE_STRESS/FOS_TANK-thermal_stress_c)) #PRESSURIZED AND UNDER THERMAL STRESS
    TANK_THICKNESS_Hc = PRESSURE_GAS/2 *R/(abs(MAX_ALLOWABLE_STRESS/FOS_TANK-thermal_stress_h))
    TANK_THICKNESS_FILLUPc = PRESSURE_GAS/2 *R/(abs(MAX_ALLOWABLE_STRESS/FOS_TANK-thermal_stress_fillup))       

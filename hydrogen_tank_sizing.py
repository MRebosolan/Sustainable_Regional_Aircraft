...
def tank_sizing(HYDROGENVOLUME, CABIN_LENGTH,N):
    ...
    R_AD= 9.81*(1/T_SURROUND)*(T_SURROUND-T_INITINSULATION)*TANK_DIAMETER**3/(GAS_DIFFUSIVITY*GAS_VISCOTY) #1/T_SURROUND IN CELCIUS
    PR = 0.71
    ...
    T_LH2 = 1 #TEMPERATURE OF THE CRYOGENIC TANK
    INSULATION_THICKNESS = 0.005 # IN METERS

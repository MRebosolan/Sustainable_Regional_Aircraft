...
for TS0 in range(155,156,5):
    ...
    TANK_THICKNESS,(STRUCTURAL_TANK_MASS),(TOTAL_STRUCTURAL_TANK_MASS), (TANK_DIAMETER),(LENGTH),EXCEED=tank_sizing(14,10,2,TS0,TANK_MATERIAL_DENSITY,EMOD,THERMALEXP,MAX_ALLOWABLE_STRESS)
    TANK_THICKNESSf,(STRUCTURAL_TANK_MASSf),(TOTAL_STRUCTURAL_TANK_MASSf), (TANK_DIAMETERf),(LENGTHf),EXCEEDf=tank_sizing_fuselage(14,1.6,1,TS0,TANK_MATERIAL_DENSITY,EMOD,THERMALEXP,MAX_ALLOWABLE_STRESS)
    print('mass and TS0 ',TOTAL_STRUCTURAL_TANK_MASSf+TOTAL_STRUCTURAL_TANK_MASS,TS0 )
    if TOTAL_STRUCTURAL_TANK_MASSf+TOTAL_STRUCTURAL_TANK_MASS<massbest and not EXCEED and not EXCEEDf:
        TS0best=TS0
        massbest=TOTAL_STRUCTURAL_TANK_MASSf+TOTAL_STRUCTURAL_TANK_MASS
